      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/60 text-lg max-w-2xl mx-auto">
            A beginner-friendly guide with practical credit-building strategies designed for newcomers. Updated for 2026.
          </p>
        </motion.div>
        ...
        >
          ...
          <span>&bull;</span>
          <span>Practical credit-building strategies</span>
          <span>&bull;</span>
